...
class CandidateUi(
    ...
    theme: Theme,
    private val horizontalView: RecyclerView,
    private val bdsRenderer: BdsCandidateRenderer? = null
) : Ui {
    ...
    override val root = bdsRenderer?.createBar(horizontalView, expandButton)
